  ...
  return(
		<>
					<div
						...
						onClick={toggle}
					></div>
					<div className="w-full h-full xs:w-11/12 md:w-1/2 xs:h-4/5 m-auto bg-drak_blue_background xs:bg-drak_blue_background z-30 centered-fixed fixed xs:mt-16 p-4">
