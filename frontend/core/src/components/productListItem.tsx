...
// 	const [upvoteCount, setUpvoteCount] = useState(itemData.upvote)
// 	const [isVotedItem, setIsVotedItem]  = useState(false)
...
// 	const mutateUpvote = useMutation(updateUpvote, {
// 		onSuccess: () => {
// 			queryClient.invalidateQueries("fetch_product_upvoted")
// 			queryClient.invalidateQueries("search_products")
// 			queryClient.invalidateQueries("products")
// 		}
// 	})
...
// 	const mutateDelete = useMutation(deleteProductUpvote, {
// 		onSuccess: () => queryClient.invalidateQueries("fetch_product_upvoted")
// 	})

// 	// const [upvotedButton, setUpvotedButton] = useState(false)

// 	let isAlreadyUpvoted;

// 	if (user != null)
// 	{
// 		isAlreadyUpvoted = useQuery(["fetch_product_upvoted", user.pk, itemData.productID], getProductUpvote)
// 	}
...
// 		if (isVotedItem && upvoteCount > 0)
// 		{
// 			console.log("downvote called ")
// 			setUpvoteCount(upvoteCount - 1)
// 			mutateUpvote.mutate({ productId: itemData.productID, field: { upvote: upvoteCount } })
// 			mutateDelete.mutate(isAlreadyUpvoted.data[0].id)
// 			setIsVotedItem(false)
// 		}
...
// 			if ( isAlreadyUpvoted.data != null && isAlreadyUpvoted.data.length > 0)
// 			{
// 			/***
// 			 * Yes This ueser ALready upvoted the items 
// 			 * So set true isVotedItem = true
// 			 */
// 				setIsVotedItem(true)
// 			} 

// 			setUpvoteCount(itemData.upvote)
...
// 		// if (typeof isAlreadyUpvoted.data != "undefined")
// 		// {
// 		// 	if (isAlreadyUpvoted.data.length != 0 && isAlreadyUpvoted.data[0].productID == itemData.productID)
// 		// 	{
// 		// 		return setUpvotedButton(true)
// 		// 	} else {
// 		// 		return setUpvotedButton(false)
...
// 	return (
// 		<>
// 			{ItemList(image, itemData.title, itemData.tagline,itemData.categories, upvoteCount)}
// 		</>
// 	);
// };
