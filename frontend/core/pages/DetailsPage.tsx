...
const Details: React.FC = () => {
	...
	const {data, error, isError, isFetching, isLoading} = useQuery(["selectProduct", id], fetchProductByID);
			...
			{ data ?
				<div>
					<div className="text-gray-100 flex space-x-5 items-center">
						<div>
							{  
								data.product_icon != "undefined" && data.product_icon.length != 0 ? (
								<img
						...
						<div className="space-y-1">
							...
							<div className="flex space-x-3 text-xs ">
								{typeof data.categories != "undefined" ? data.categories.map(({ name }) => (
